...
$definedBattleCards = [
    ...
    ["name" => "Time machine", "power" => "7", "energy" => "5", "balance" => "4", "onReveal" => "Double the |onGoingL| onGoing location effect", "onGoing" => "", "special" => "This cards |onReveal| onReveal abillity happens after the |onGoingL| onGoing Location abillity", "description" => "", "type" => "Wind", "series" => "Mushroom"],
