...
$definedBattleCards = [
    ...
    // B091 - B100
    ["name" => "14x14 piston door", "power" => "3", "energy" => "3", "balance" => "1", "onReveal" => "", "onGoing" => "Has 7 total |Power| power if redstone is played anywhere this game", "description" => "it's actually quite simple", "special" => "", "type" => "Earth", "series" => "block game", "image" => ""],
    ...
    ["name" => "Poultry Man", "power" => "3", "energy" => "1", "balance" => "3", "onReveal" => "give 2 (B005) Egg cards to yourself and 1 (B005) Egg card to an opponent of choice", "onGoing" => "", "description" => "Poultry man strikes again!", "special" => "", "type" => "Fire", "series" => "revolution block game", "image" => ""],
