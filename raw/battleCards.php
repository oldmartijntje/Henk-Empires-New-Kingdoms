...
$definedBattleCards = [
    ...
    ["name" => "Egg", "amount"=>"12","deck"=> "S","power" => 2,"energy" => 1,"balance" => 1,"onReveal" => "","onGoing" => "","description" => "unborn Fried Chick","special" => "","image" => "","type" => "Fire","series" => ""],
    ["name" => "Forced Parking","power" => 3,"energy" => 1,"balance" => 4,"onReveal" => "pick someones card (blindly) they have to play it (if they have 3 energy left), the cost of that card is now 3","onGoing" => "","description" => "","special" => "","image" => "","type" => "Earth","series" => ""],
    ...
    ["name" => "Hate Comment", "power" => "6", "energy" => "4", "balance" => "3", "onReveal" => "", "onGoing" => "This card has 6 extra power if it's the only card you have played", "special" => "", "description" => "very anonymous", "type" => "Wind"],
    ...
    ["name" => "Failed Experiment", "power" => "5", "energy" => "4", "balance" => "2", "onReveal" => "", "onGoing" => "all cards cost 2", "special" => "", "description" => "Don't cluck with fire cluck", "type" => "Fire", "series" => "revolution"],
    ...
    ["name" => "Confusing traffic", "power" => "4", "energy" => "3", "balance" => "1", "onReveal" => "next card you play will get it's power and energy doubled", "onGoing" => "", "special" => "", "description" => "Not enough signs", "type" => "Fire", "series" => ""],
    ...
    ["name" => "Electrician Chick", "power" => "2", "energy" => "2", "balance" => "1", "onReveal" => "", "onGoing" => "all your water type cards cost 1 less energy", "special" => "", "description" => "Cluck Cluck bzztt", "type" => "Electric", "series" => "revolution"],     
    ...
    ["name" => "Hidden Mcdonalds", "power" => "-1", "energy" => "0", "balance" => "1", "onReveal" => "steal 1 energy from all other players (if they have any left)", "onGoing" => "", "special" => "", "description" => "Chicken nuggies hunt", "type" => "Earth", "series" => ""],
    // B051 - B060
    ["name" => "Volcano", "power" => "4", "energy" => "0", "balance" => "3", "onReveal" => "For every fire type card in game (played by any player), give this card +1 power", "onGoing" => "", "special" => "This cards energy cost is the amount of (unplayed) cards you have in your hand", "description" => "", "type" => "Fire", "series" => ""],
    ["name" => "Nuclear Powerplant", "power" => "2", "energy" => "0", "balance" => "1", "onReveal" => "For every water type card in the game (played by any player), give this card +1 power", "onGoing" => "", "special" => "This cards energy cost is the amount of (unplayed) cards you have in your hand", "description" => "", "type" => "Electric", "series" => ""],
    ["name" => "", "power" => "3", "energy" => "0", "balance" => "2", "onReveal" => "For every earth type card in the game (played by any player), give this card +1 power", "onGoing" => "", "special" => "This cards energy cost is the amount of (unplayed) cards you have in your hand", "description" => "", "type" => "Earth", "series" => ""],
    ["name" => "", "power" => "1", "energy" => "0", "balance" => "1", "onReveal" => "For every wind type card in the game (played by any player), give this card +1 power", "onGoing" => "", "special" => "This cards energy cost is the amount of (unplayed) cards you have in your hand", "description" => "", "type" => "Wind", "series" => ""],
    ...
    ["name" => "Dragon", "power" => "5", "energy" => "3", "balance" => "4", "onReveal" => "", "onGoing" => "Has +10 if Lloyd (B055) is also played (anywhere)", "description" => "", "special" => "", "type" => "Green", "series" => "Ninja", "image" => ""],
    ["name" => "Golden Mech", "power" => "2", "energy" => "3", "balance" => "4", "onReveal" => "", "onGoing" => "Has +10 if Lloyd (B055) or Mech Sword (B058) is also played (anywhere)", "description" => "", "special" => "", "type" => "Green", "series" => "Ninja", "image" => ""],
    ["name" => "Mech Sword", "power" => "4", "energy" => "2", "balance" => "3", "onReveal" => "", "onGoing" => "Has +10 if Golden Mech (B057) is also played (anywhere)", "description" => "", "special" => "", "type" => "Electric", "series" => "Ninja", "image" => ""],
    ["name" => "", "power" => "3", "energy" => "3", "balance" => "3", "onReveal" => "", "onGoing" => "double the power of all electro type cards you have played", "description" => "", "special" => "", "type" => "Wind", "series" => "", "image" => ""],
    ["name" => "", "power" => "4", "energy" => "2", "balance" => "2", "onReveal" => "Give every electro type card in game (played by any player) +1 power", "onGoing" => "", "description" => "", "special" => "", "type" => "Water", "series" => "", "image" => ""],
    // B061 - B070
    ["name" => "", "power" => "5", "energy" => "4", "balance" => "2", "onReveal" => "Give every electro type card in game (played by any player) +2 power", "onGoing" => "", "description" => "", "special" => "", "type" => "Water", "series" => "", "image" => ""],
    ["name" => "Lakitunder", "power" => "4", "energy" => "2", "balance" => "2", "onReveal" => "For your electro type cards, give this card +1 power", "onGoing" => "", "description" => "", "special" => "", "type" => "Water", "series" => "Mushroom", "image" => ""],
    ["name" => "", "power" => "5", "energy" => "4", "balance" => "2", "onReveal" => "For your electro type cards, give this card +2 power", "onGoing" => "", "description" => "", "special" => "", "type" => "Water", "series" => "", "image" => ""],
    ["name" => "Large Question Block", "power" => "8", "energy" => "6", "balance" => "4", "onReveal" => "Reactivate all your on reveal abillities", "onGoing" => "", "description" => "", "special" => "", "type" => "Water", "series" => "Mushroom", "image" => ""],
    ["name" => "Cosmic Clone", "power" => "0", "energy" => "3", "balance" => "1", "onReveal" => "", "onGoing" => "", "description" => "", "special" => "This card becomes the last card you played", "type" => "???", "series" => "Mushroom", "image" => ""],
    ["name" => "Tsunami", "power" => "2", "energy" => "4", "balance" => "2", "onReveal" => "Everyone (you too) takes all played cards (except this one) back into their hand (they don't get their energy back)", "onGoing" => "", "description" => "", "special" => "This does not have effect on (B052) Nuclear Powerplant", "type" => "Water", "series" => "", "image" => ""],
    ...
    ["name" => "", "power" => "8", "energy" => "1", "balance" => "4", "onReveal" => "", "onGoing" => "Someone else (opponent) choses (blindly) what cards you play, all your cards cost 3 energy", "description" => "", "special" => "Needs to be the first or second card you play, this can't be the last card you play.", "type" => "Water", "series" => "", "image" => ""],
    ["name" => "Cardbord airplane", "power" => "-5", "energy" => "1", "balance" => "0", "onReveal" => "", "onGoing" => "", "description" => "", "special" => "Play this at someone else, they keep this card after this battle is over", "type" => "Wind", "series" => "Fun", "image" => ""],
    ["name" => "Rock", "amount"=>"4", "deck" => "S", "power" => "0", "energy" => "1", "balance" => "", "onReveal" => "", "onGoing" => "", "description" => "Well, that's useless", "special" => "", "type" => "Earth", "series" => "", "image" => ""],
    // B071 - B080
    ...
    ["name" => "Bleach shower", "power" => "4", "energy" => "2", "balance" => "3", "onReveal" => "remove all effects from all cards in everyones hands (yourself too)", "onGoing" => "", "description" => "", "special" => "", "type" => "Water", "series" => "", "image" => ""],
    ["name" => "Black Hole Gun", "power" => "3", "energy" => "3", "balance" => "4", "onReveal" => "change the location to black hole (L013) (cards have no effects)", "onGoing" => "", "description" => "", "special" => "", "type" => "Water", "series" => "", "image" => ""],
    ["name" => "Question Block", "power" => "1", "energy" => "3", "balance" => "2", "onReveal" => "next card you play has it's on reveal effects doubled", "onGoing" => "", "description" => "", "special" => "", "type" => "Fire", "series" => "Mushroom", "image" => ""],
    ["name" => "Double Strawberry", "power" => "2", "energy" => "3", "balance" => "2", "onReveal" => "next card you play has it's ongoing effects doubled", "onGoing" => "", "description" => "", "special" => "", "type" => "Earth", "series" => "Mushroom", "image" => ""],
    ["name" => "Revenge", "power" => "4", "energy" => "5", "balance" => "5", "onReveal" => "", "onGoing" => "after an opponents card effect applies to this card, double the power of this card", "description" => "", "special" => "", "type" => "Wind", "series" => "revolution", "image" => ""],
    ["name" => "Error", "power" => "4", "energy" => "2", "balance" => "2", "onReveal" => "change the location to 404-NOTFOUND (L010) (nothing happens)", "onGoing" => "", "description" => "", "special" => "", "type" => "Water", "series" => "", "image" => ""],
    ...
    ["name" => "", "power" => "3", "energy" => "2", "balance" => "2", "onReveal" => "change the location to Flooding (L019) (turns into flooded (L020) next turn)", "onGoing" => "", "description" => "", "special" => "", "type" => "Water", "series" => "", "image" => ""],
    ["name" => "BBQ Duck","amount"=>"12", "deck"=> "S","power" => "4", "energy" => "3", "balance" => "4", "onReveal" => "", "onGoing" => "when there are more BBQ ducks played (anywhere), double this BBQ duck his power", "description" => "", "special" => "", "type" => "Water", "series" => "Henk", "image" => ""],
    // B081 - B090
    ...
    ["name" => "", "power" => "0", "energy" => "4", "balance" => "1", "onReveal" => "", "onGoing" => "double your total power ", "description" => "", "special" => "", "type" => "Fire", "series" => "", "image" => ""],
    ...
    ["name" => "Harumi", "power" => "2", "energy" => "1", "balance" => "2", "onReveal" => "Invert the effect of type green cards that are already played", "onGoing" => "", "description" => "", "special" => "", "type" => "Wind", "series" => "Ninja", "image" => ""],
    ...
    ["name" => "Bread", "amount"=>"8", "deck" => "S", "power" => "2", "energy" => "1", "balance" => "1", "onReveal" => "", "onGoing" => "", "description" => "", "special" => "", "type" => "Earth", "series" => "block game", "image" => ""],
    ["name" => "Grian", "power" => "4", "energy" => "2", "balance" => "3", "onReveal" => "", "onGoing" => "Gains +2 power for every Bread (B087) played, Gains +3 power if there is Mumbo Jumbo (B089) played, Loses -4 power if there is Redstone (B090) played anywhere this game", "description" => "", "special" => "", "type" => "Wind", "series" => "block game", "image" => ""],
    ["name" => "Mumbo Jumbo", "power" => "4", "energy" => "2", "balance" => "3", "onReveal" => "", "onGoing" => "Gains +2 power if there is redstone (B090), Gains +3 power if there is Grian (B088) played anywhere this game", "description" => "", "special" => "", "type" => "Wind", "series" => "block game", "image" => ""],
    ["name" => "Redstone", "power" => "4", "energy" => "3", "balance" => "1", "onReveal" => "", "onGoing" => "", "description" => "", "special" => "", "type" => "Earth", "series" => "block game", "image" => ""],
    // B091 - B100
    ["name" => "14x14 piston door", "power" => "1", "energy" => "3", "balance" => "1", "onReveal" => "", "onGoing" => "Has 7 total power if redstone is played anywhere this game", "description" => "it's actually quite simple", "special" => "", "type" => "Earth", "series" => "block game", "image" => ""],
    ...
    ["name" => "Ariana Griande", "power" => "2", "energy" => "2", "balance" => "1", "onReveal" => "", "onGoing" => "", "description" => "Mumbojumbo you are AFK", "special" => "", "type" => "Wind", "series" => "block game", "image" => ""],
    ["name" => "0-point", "power" => "1", "energy" => "2", "balance" => "4", "onReveal" => "all cards get their power set to 1 (af a card had a booster from +1 and loses it after this card, it willl subtract the lost booster from 1 power)", "onGoing" => "", "description" => "", "special" => "", "type" => "Earth", "series" => "", "image" => ""],
    ["name" => "Shortcut", "power" => "10", "energy" => "3", "balance" => "1", "onReveal" => "", "onGoing" => "Has 1 less power for each water type card played by any player", "description" => "Very safe shortcut", "special" => "", "type" => "Earth", "series" => "", "image" => ""],
    ["name" => "I am lost?", "power" => "2", "energy" => "1", "balance" => "1", "onReveal" => "Every opponent loses 2 energy (if they have any left)", "onGoing" => "", "description" => "I want to go home.", "special" => "", "type" => "Earth", "series" => "", "image" => ""],
    ["name" => "Poultry Man", "power" => "3", "energy" => "1", "balance" => "3", "onReveal" => "give 2 (B005) Egg cards to yourself and 1 (B005) Egg card to an opponent of choice", "onGoing" => "", "description" => "Poultry man strikes again!", "special" => "", "type" => "Fire", "series" => "revolution", "image" => ""],
    ["name" => "Pesky Bird", "power" => "3", "energy" => "2", "balance" => "2", "onReveal" => "Give all |block game| series cards that you own 2 extra power", "onGoing" => "", "description" => "Pesky bird!", "special" => "", "type" => "Wind", "series" => "block game", "image" => ""]
];
