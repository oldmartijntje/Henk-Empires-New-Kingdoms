...
$definedBattleCards = [
    ...
    ["name" => "Hidden Mcdonalds", "power" => "-1", "energy" => "0", "balance" => "1", "onReveal" => "steal 1 energy from all other players (if they have any left)", "onGoing" => "", "special" => "", "description" => "Chicken nuggies", "type" => "Earth", "series" => ""],
    // B051 - B060
