...
$definedBattleCards = [
    ...
    ["name" => "Egg","power" => 2,"energy" => 1,"balance" => 1,"onReveal" => "","onGoing" => "","description" => "Fried Egg","special" => "","image" => "","type" => "Fire","series" => ""],
    ...
    // B011 - B020
    ["name" => "Inspiration","power" => 4,"energy" => 3,"balance" => 1,"onReveal" => "","onGoing" => "","description" => "i am ironcluck","special" => "","image" => "","type" => "Earth","series" => "revolution"],
    ...
    ["name" => "Tractor Chick", "power" => "5", "energy" => "3", "balance" => "4", "onReveal" => "", "onGoing" => "all cards lost their abilities (except this one)", "special" => "", "description" => "Cluck vroom cluck", "type" => "Water", "series" => "revolution"],   
    ...
    ["name" => "Rock", "deck" => "S", "power" => "0", "energy" => "1", "balance" => "", "onReveal" => "", "onGoing" => "", "description" => "Well, that's useless", "special" => "", "type" => "Earth", "series" => "", "image" => ""],
    // B071 - B080
    ...
    ["name" => "BBQ Duck", "deck"=> "S","power" => "4", "energy" => "3", "balance" => "4", "onReveal" => "", "onGoing" => "when there are more BBQ ducks played (anywhere), double this BBQ duck his power", "description" => "", "special" => "", "type" => "Water", "series" => "Henk", "image" => ""],
    // B081 - B090
    ...
    ["name" => "Bread", "deck" => "S", "power" => "2", "energy" => "1", "balance" => "1", "onReveal" => "", "onGoing" => "", "description" => "", "special" => "", "type" => "Earth", "series" => "block game", "image" => ""],
    ...
    // B091 - B100
    ["name" => "14x14 piston door", "power" => "1", "energy" => "3", "balance" => "1", "onReveal" => "", "onGoing" => "Has 7 power if redstone is played anywhere this game", "description" => "it's actually quite simple", "special" => "", "type" => "Earth", "series" => "block game", "image" => ""],
    ...
    ["name" => "Ariana Griande", "power" => "2", "energy" => "2", "balance" => "1", "onReveal" => "Give all |block game| series cards that you own 2 extra power", "onGoing" => "", "description" => "Mumbojumbo you are AFK", "special" => "", "type" => "Wind", "series" => "block game", "image" => ""],
