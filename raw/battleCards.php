...
$definedBattleCards = [
    ...
    "energy" => 1,
    "balance" => 4,
    "onReveal" => "pick someones card (blindly) they have to play it (if they have 3 energy left), the cost of that card is now 3",
    "onGoing" => "",
    "description" => "",
    "special" => "",
    "image" => "",
    ...
    "energy" => 2,
    "balance" => 0,
    "onReveal" => "Play a rock (B070) at someone else",
    "onGoing" => "",
    "description" => "",
    "special" => "",
    "image" => "",
    ...
    "balance" => 3,
    "onReveal" => "",
    "onGoing" => "Players can only play 1 card per turn",
    "description" => "",
    "special" => "",
    "image" => "",
    "type" => "Water",
