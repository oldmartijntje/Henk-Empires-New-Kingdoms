...
$definedBattleCards = [
    ...
    ["name" => "Nuclear Powerplant", "power" => "2", "energy" => "0", "balance" => "1", "onReveal" => "For every water type card in the game (played by any player), give this card +1 power", "onGoing" => "", "special" => "This costs the amount of cards you have in your hand", "description" => "", "type" => "Electric", "series" => ""],
