...
$definedBattleCards = [
    ...
    ["name" => "Quirk-Destroying Drug", "power" => "4", "energy" => "2", "balance" => "3", "onReveal" => "", "onGoing" => "Your cards don't have abilities anymore (except this one)", "special" => "", "description" => "", "type" => "Wind", "series" => ""],
    ...
    ["name" => "Mr Compass", "power" => "10", "energy" => "4", "balance" => "3", "onReveal" => "choose 1 battlecard from every player's hand (blindly) they will play that card for free", "onGoing" => "", "special" => "", "description" => "", "type" => "Earth", "series" => ""],
    // B031 - B040
    ...
    ["name" => "All for One", "power" => "2", "energy" => "3", "balance" => "1", "onReveal" => "next card you play will get it's |Power| power doubled", "onGoing" => "", "special" => "", "description" => "", "type" => "Water", "series" => ""],     
    ...
    ["name" => "Thinking Kanari", "power" => "7", "energy" => "5", "balance" => "4", "onReveal" => "", "onGoing" => "all your |Water| type cards cost 1 less |Energy| Energy", "special" => "", "description" => "", "type" => "Electric", "series" => ""],     
    ...
    ["name" => "Wet chick", "power" => "3", "energy" => "2", "balance" => "2", "onReveal" => "change the location to Flooding (L019) (turns into flooded (L020) next turn)", "onGoing" => "", "description" => "Blub", "special" => "", "type" => "Water", "series" => "revolution", "image" => ""],
