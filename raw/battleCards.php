...
$definedBattleCards = [
    ...
    // B021 - B030
    ["name" => "Dr. Strange", "power" => "8", "energy" => "6", "balance" => "2", "onReveal" => "Remove all |onGoing| ongoing effects from all cards in everyone's hands", "onGoing" => "", "special" => "", "description" => "", "type" => "Fire", "series" => ""],
    ...
    ["name" => "Duck Compress", "power" => "10", "energy" => "4", "balance" => "3", "onReveal" => "choose 1 battlecard from every player's hand (blindly) they will play that card for free", "onGoing" => "", "special" => "", "description" => "", "type" => "Earth", "series" => ""],
    // B031 - B040
    ...
    ["name" => "Quack for One", "power" => "2", "energy" => "3", "balance" => "1", "onReveal" => "next card you play will get it's |Power| power doubled", "onGoing" => "", "special" => "", "description" => "", "type" => "Water", "series" => ""],     
    ...
    ["name" => "Quacki Kaminari", "power" => "7", "energy" => "5", "balance" => "4", "onReveal" => "", "onGoing" => "all your |Water| type cards cost 1 less |Energy| Energy", "special" => "", "description" => "", "type" => "Electric", "series" => ""],     
