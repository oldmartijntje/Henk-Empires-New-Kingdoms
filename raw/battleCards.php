...
$definedBattleCards = [
    ...
    ["name" => "", "power" => "7", "energy" => "5", "balance" => "4", "onReveal" => "", "onGoing" => "all your |Wind| type cards cost 1 less |Energy| Energy", "special" => "", "description" => "", "type" => "Wind", "series" => ""],
    ...
    ["name" => "", "power" => "8", "energy" => "1", "balance" => "4", "onReveal" => "", "onGoing" => "Someone else (opponent) choses (blindly) what cards you play, all your cards cost 3 |Energy| Energy", "description" => "", "special" => "Needs to be the first or second card you play, this can't be the last card you play.", "type" => "Water", "series" => "", "image" => ""],
    ...
    ["name" => "Grian", "power" => "4", "energy" => "2", "balance" => "3", "onReveal" => "", "onGoing" => "Gains +2 |Power|power for every Bread (B087) played, Gains +3 |Power|power if there is Mumbo Jumbo (B089) played, Loses -4 |Power|power if there is Redstone (B090) played anywhere this game", "description" => "", "special" => "", "type" => "Wind", "series" => "block game", "image" => ""],
    ["name" => "Mumbo Jumbo", "power" => "4", "energy" => "2", "balance" => "3", "onReveal" => "", "onGoing" => "Gains +2 |Power|power if there is redstone (B090), Gains +3 |Power|power if there is Grian (B088) played anywhere this game", "description" => "", "special" => "", "type" => "Wind", "series" => "block game", "image" => ""],
    ["name" => "Redstone", "power" => "4", "energy" => "3", "balance" => "1", "onReveal" => "", "onGoing" => "", "description" => "", "special" => "", "type" => "Earth", "series" => "block game", "image" => ""],
    // B091 - B100
    ["name" => "14x14 piston door", "power" => "1", "energy" => "3", "balance" => "1", "onReveal" => "", "onGoing" => "Has 7 total |Power|power if redstone is played anywhere this game", "description" => "it's actually quite simple", "special" => "", "type" => "Earth", "series" => "block game", "image" => ""],
    ...
    ["name" => "Pesky Bird", "power" => "3", "energy" => "2", "balance" => "2", "onReveal" => "Give all |block game| series cards that you own 2 extra |Power|power", "onGoing" => "", "description" => "Pesky bird!", "special" => "", "type" => "Wind", "series" => "block game", "image" => ""]
];
