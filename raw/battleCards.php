...
$definedBattleCards = [
    ...
    ["name" => "", "power" => "7", "energy" => "3", "balance" => "3", "onReveal" => "", "onGoing" => "", "special" => "when played, after battle is over give this card to the player in last place", "description" => "", "type" => "Fire", "series" => ""],
    ...
    ["name" => "", "power" => "7", "energy" => "5", "balance" => "4", "onReveal" => "", "onGoing" => "all your fire type cards cost 1 less energy", "special" => "", "description" => "", "type" => "Fire", "series" => ""],
