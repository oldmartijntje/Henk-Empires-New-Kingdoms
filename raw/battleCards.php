...
$definedBattleCards = [
    ...
    ["name" => "Princess Shroob", "power" => "-5", "energy" => "2", "balance" => "1", "onReveal" => "", "onGoing" => "Disable all |onReveal| on reveal effects for everyone", "special" => "", "description" => "|shroobLang1||shroobLang2|!!!!", "type" => "Earth", "series" => ""],
    ...
    // B021 - B030
    ["name" => "Duckter Strange", "power" => "8", "energy" => "6", "balance" => "2", "onReveal" => "Remove all |onGoing| ongoing effects from all cards in everyone's hands", "onGoing" => "", "special" => "", "description" => "", "type" => "Fire", "series" => "DUCKIFY"],
    ...
    ["name" => "Quirk-Destroying Drug", "power" => "4", "energy" => "2", "balance" => "3", "onReveal" => "", "onGoing" => "Your cards don't have abilities anymore (except this one)", "special" => "", "description" => "", "type" => "Wind", "series" => "DUCKIFY"],
    ...
    ["name" => "Failed Experiment", "power" => "5", "energy" => "4", "balance" => "2", "onReveal" => "", "onGoing" => "all cards cost 2 extra |Energy| Energy", "special" => "", "description" => "Don't cluck with fire cluck", "type" => "Fire", "series" => "revolution"],
    ["name" => "Duck Compress", "power" => "10", "energy" => "4", "balance" => "3", "onReveal" => "choose 1 battlecard from every player's hand (blindly) they will play that card for free", "onGoing" => "", "special" => "", "description" => "", "type" => "Earth", "series" => "DUCKIFY"],
    // B031 - B040
    ...
    ["name" => "Quack for One", "power" => "2", "energy" => "3", "balance" => "1", "onReveal" => "next card you play will get it's |Power| power doubled", "onGoing" => "", "special" => "", "description" => "", "type" => "Water", "series" => "DUCKIFY"],     
    ...
    ["name" => "Time machine", "power" => "4", "energy" => "3", "balance" => "2", "onReveal" => "Double the |onGoingL| onGoing location effect", "onGoing" => "", "special" => "This cards |onReveal| onReveal abillity happens after the |onGoingL| onGoing Location abillity", "description" => "", "type" => "Wind", "series" => "Mushroom"],
    ...
    ["name" => "Quacki Kaminari", "power" => "7", "energy" => "5", "balance" => "4", "onReveal" => "", "onGoing" => "all your |Water| type cards cost 1 less |Energy| Energy", "special" => "", "description" => "", "type" => "Electric", "series" => "DUCKIFY"],     
    ...
    ["name" => "Shroobs", "power" => "3", "energy" => "9", "balance" => "3", "onReveal" => "Steal the last played card from every opponent and play them for free.", "onGoing" => "", "special" => "", "description" => "|shroobLang1||shroobLang12||shroobLang17||shroobLang8||shroobLang5||shroobLang3|! |shroobLang6||shroobLang1||shroobLang8|!", "type" => "Wind", "series" => "Mushroom"],
    ...
    ["name" => "P-switch", "power" => "8", "energy" => "6", "balance" => "4", "onReveal" => "Reactivate all your on reveal abillities except this one.", "onGoing" => "", "description" => "", "special" => "", "type" => "Water", "series" => "Mushroom", "image" => ""],
    ["name" => "Tree Network", "power" => "0", "energy" => "3", "balance" => "1", "onReveal" => "", "onGoing" => "", "description" => "", "special" => "This card becomes the last card you played", "type" => "???", "series" => "Mushroom", "image" => ""],
    ...
    ["name" => "Ducko Brando", "power" => "3", "energy" => "2", "balance" => "1", "onReveal" => "", "onGoing" => "you won't reveal your cards till the end of the game", "description" => "", "special" => "", "type" => "Fire", "series" => "DUCKIFY", "image" => ""],
