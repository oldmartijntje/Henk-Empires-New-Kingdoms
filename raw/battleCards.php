...
$definedBattleCards = [
    ...
    ["name" => "Double Strawberry", "power" => "2", "energy" => "3", "balance" => "2", "onReveal" => "next card you play has it's |onGoing| ongoing effects doubled", "onGoing" => "", "description" => "", "special" => "", "type" => "Earth", "series" => "Mushroom", "image" => ""],
