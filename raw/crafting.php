...
$definedCraftings = [
    ...
    ["costs" => "|wheatRecourse||wheatRecourse||oreRecourse||oreRecourse||oreRecourse|", "reward" => "1 x |battleCard|", "amount"=> 1],
    ["costs" => "|wheatRecourse||oreRecourse||woodRecourse||stoneRecourse||woolRecourse|", "reward" => "1 x |battleCard|", "amount"=> 1],
    ["costs" => "|gem5||woodRecourse||stoneRecourse|", "reward" => "1 x |battleCard|", "amount"=> 1],
    ["costs" => "|wheatRecourse||wheatRecourse||oreRecourse|", "reward" => "11 x |money|", "amount"=> 1],
    ["costs" => "|gem1||wheatRecourse||oreRecourse|", "reward" => "19 x |money|", "amount"=> 1],
    ["costs" => "|gem2||woodRecourse||stoneRecourse|", "reward" => "18 x |money|", "amount"=> 1],
    ["costs" => "|woodRecourse| 10 x |money|", "reward" => "2 x |VP|", "amount"=> 1],
    ["costs" => "|gem3||oreRecourse||stoneRecourse|", "reward" => "12 x |money| <br>3 x |VP|", "amount"=> 1],
    ["costs" => "|woolRecourse||gem4||wheatRecourse||woolRecourse|", "reward" => "1 x |battleCard| <br>3 x |VP|", "amount"=> 1],
    ...
    ["costs" => "|wheatRecourse||oreRecourse||oreRecourse||oreRecourse||gemR|", "reward" => "6 x |VP|", "amount"=> 1],
    ["costs" => "|wheatRecourse||oreRecourse||oreRecourse||gem6||gemR|", "reward" => "9 x |VP|", "amount"=> 1],
