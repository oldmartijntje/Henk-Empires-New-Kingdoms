...
$definedLocations = [
    // L001 - L010
    ["name" => "Celeste mountain", "onGoingL" => "Double the |onGoing| onGoing effects", "icons" => "", "description" => "", "image" => ""],
    ...
    ["name" => "Sahara", "onGoingL" => "all cards cost 1 |Energy| less", "icons" => "blockgame", "description" => "Sand!", "image" => ""],
    ["name" => "The Allan dessert", "onGoingL" => "all cards cost 1 |Energy| more", "icons" => "", "description" => "Dessert of lost memories", "image" => ""],
    ...
    ["name" => "Het Binnenhof", "onGoingL" => "only 2 cards can be played per person", "icons" => "", "description" => "Home of Mark Rutte", "image" => ""],
    ["name" => "Black hole", "onGoingL" => "cards have no effects", "icons" => "", "description" => "", "image" => ""],
    ["name" => "The Matrix", "onGoingL" => "|onGoing| onGoing effects are disabled", "icons" => "", "description" => "", "image" => ""],
    ["name" => "Dying planet", "onGoingL" => "|onReveal| on reveal effects are disabled", "icons" => "Mushroom", "description" => "|shroobLang1||shroobLang2|!!!!", "image" => ""],
    ...
    ["name" => "Hollijolli Village", "onGoingL" => "you can only play 1 card per turn", "icons" => "Mushroom", "description" => "|shroobLang6||shroobLang2||shroobLang9||shroobLang17|!", "image" => ""],
    ...
    // L021 - L030
    ["name" => "Oudendijk", "onGoingL" => "you can only play cards here that have effects", "icons" => "", "description" => "", "image" => ""],
    ...
    ["name" => "Cantine", "onGoingL" => "3 and 4 |Energy| cost cards cost 5 |Energy|", "icons" => "", "description" => "That's expensive|eyesEmoji|", "image" => ""],
    ...
    ["name" => "Time hole", "specialL" => "It's not turn based. Set a 5 minute timer, everyone can play cards whenever they want. Battle is over when timer finishes.", "icons" => "Mushroom", "description" => "", "image" => ""],
    ...
    ["name" => "Please donate", "specialL" => "You can play cards at everyone, not just yourself.", "icons" => "", "description" => "", "image" => ""],
];
